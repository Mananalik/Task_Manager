...
export const resetPassword = asyncHandler(async (req, res) => {
  ...
  console.log("Received resetPasswordToken:", resetPasswordToken); // ✅ Debugging
  console.log("Received resetPasswordToken:", req.params.resetPasswordToken); // ✅ Check extracted token
  if (!password) {
